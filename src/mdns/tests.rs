...
mod tests {
    ...
    const ANSWER_MACHINE1_MDNS_PAYLOAD_ANSWERS_WITH_REFERENCE_PART: [u8; 34] = [5, 95, 104, 116, 116, 112, 4, 95, 116, 99, 112, 5, 108, 111, 99, 97, 108, 0, 0, 12, 0, 1, 0, 0, 17, 148, 0, 6, 3, 104, 117, 98, 192, 12];
